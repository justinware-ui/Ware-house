...
import {
  ...
  Image, Pilcrow, ChevronDown, CircleHelp, Sparkles,
} from 'lucide-react'
...
export default function CtaNode({ id, data }: NodeProps) {
  ...
  const [answers, setAnswers] = useState<Answer[]>([{ id: 0, value: '' }])
  ...
  return (
    <div
      ...
      style={{ width: tooltipMode ? Math.max(cardWidth, 320) : cardWidth }}
    >
      <span
        ref={measureRef}
          ...
          <div className="flex flex-col gap-5">
            {answers.map((answer, index) => (
              <div
                ...
                className={`nodrag flex items-start gap-3 relative transition-opacity ${
              ...
              >
                ...
                {/* Input */}
                <div className="flex-1 min-w-0 pb-2 border-b border-gray-200 focus-within:border-brand-400 transition-colors overflow-hidden" data-answer-content>
                  {answer.image && (
                    <div
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover/img:opacity-100 transition-opacity pointer-events-none">
                        ...
                        <div className="relative z-10 flex items-center bg-white rounded-full border border-[#D6D1CB] px-2 py-2 gap-1 shadow-lg pointer-events-auto">
                          ...
                          <div className="relative group/replace">
                            ...
                            >
                              <svg width="18" height="18" viewBox="2 3 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6 14.25a.728.728 0 0 1-.535-.216.728.728 0 0 1-.215-.534c0-.213.072-.391.215-.535A.728.728 0 0 1 6 12.75h4.575c.787 0 1.472-.25 2.053-.75.581-.5.872-1.125.872-1.875S13.209 8.75 12.628 8.25c-.581-.5-1.266-.75-2.053-.75H5.85l1.425 1.425a.706.706 0 0 1 .206.475.706.706 0 0 1-.206.525.706.706 0 0 1-.525.206.706.706 0 0 1-.525-.206l-2.7-2.7a.874.874 0 0 1-.16-.244.756.756 0 0 1-.046-.281c0-.1.015-.194.046-.281a.874.874 0 0 1 .16-.244l2.7-2.7a.706.706 0 0 1 .525-.206c.213 0 .388.069.525.206a.706.706 0 0 1 .206.525.706.706 0 0 1-.206.525L5.85 6h4.725c1.213 0 2.253.394 3.122 1.181.869.788 1.303 1.769 1.303 2.944 0 1.175-.434 2.156-1.303 2.944-.869.787-1.91 1.181-3.122 1.181H6Z" fill="#172537"/>
                              </svg>
                            </button>
